...
void adc_init(void)
{
    ...
    SET_BIT(GPIOE->MODER, GPIO_MODER_MODE13_1 | GPIO_MODER_MODE13_0);  // TEMP.T3
    ...
    MODIFY_REG(ADC1->SQR1, ADC_SQR1_L_Msk, (10 << ADC_SQR1_L_Pos));
    // Configure channel sequence order
    // Order read out of ADC buffers will be ADC.CH1 -> ADC.CH10
    MODIFY_REF(ADC1->SQR1, ADC_SQR1_SQ1_Msk,  (1  << ADC_SQR1_SQ1_Pos));
    MODIFY_REF(ADC1->SQR1, ADC_SQR1_SQ2_Msk,  (5  << ADC_SQR1_SQ2_Pos));
    MODIFY_REF(ADC1->SQR1, ADC_SQR1_SQ3_Msk,  (8  << ADC_SQR1_SQ3_Pos));
    MODIFY_REF(ADC1->SQR1, ADC_SQR1_SQ4_Msk,  (4  << ADC_SQR1_SQ4_Pos));
    MODIFY_REF(ADC1->SQR2, ADC_SQR2_SQ5_Msk,  (6  << ADC_SQR2_SQ5_Pos));
    MODIFY_REF(ADC1->SQR2, ADC_SQR2_SQ6_Msk,  (2  << ADC_SQR2_SQ6_Pos));
    MODIFY_REF(ADC1->SQR2, ADC_SQR2_SQ7_Msk,  (7  << ADC_SQR2_SQ7_Pos));
    MODIFY_REF(ADC1->SQR2, ADC_SQR2_SQ8_Msk,  (9  << ADC_SQR2_SQ8_Pos));
    MODIFY_REF(ADC1->SQR2, ADC_SQR2_SQ9_Msk,  (3  << ADC_SQR2_SQ9_Pos));
    MODIFY_REF(ADC1->SQR3, ADC_SQR3_SQ10_Msk, (13 << ADC_SQR3_SQ10_Pos));
